...
<html>
    <head>
        ...
        <title>:::Geolitic:::Graficando una Recta</title>
    ...
    <body>
        <div class="container">            
            ...
            <div class="row">
                ...
                <br>
                <br>
                <h2 style="text-align: center;">Recta </h2>
                <br><br>

                <div class="row">
                    <form id="form" class="form-horizontal">
                        <label for="eq" class="control-label col-md-3"><img class="img-responsive img-thumbnail" src="../img/recta.jpg" title="Ingresa la ecuación despues del igual" style="margin-top: -5px;"/></label>                        
                        <div class="col-md-7">
